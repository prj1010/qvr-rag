...
uv pip install --python "%PY%" --upgrade "langchain-text-splitters>=0.3,<0.4" "pillow>=10,<13" "pymupdf>=1.24,<2" "pypdf>=5,<7" "pytesseract>=0.3.13,<1" "python-docx>=1.1,<2" "kokoro-onnx>=0.6.1,<0.7" "soundfile>=0.12,<1" "numpy>=1.26,<3"
if errorlevel 1 exit /b 1
