...
echo Installing local document parsing dependencies...
uv pip install --python "%PY%" --upgrade "langchain-text-splitters>=0.3,<0.4" "pillow>=10,<13" "pymupdf>=1.24,<2" "pypdf>=5,<7" "pytesseract>=0.3.13,<1" "python-docx>=1.1,<2"
if errorlevel 1 exit /b 1
